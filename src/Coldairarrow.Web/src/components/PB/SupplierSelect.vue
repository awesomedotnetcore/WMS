<template>
  <div>
    <a-row>
      <a-col :span="20">
        <a-select v-model="curValue" placeholder="供应商/下料点" :disabled="disabled" @select="onSelect" @search="handleSearch" :allowClear="true" :showSearch="true" :filterOption="false">
