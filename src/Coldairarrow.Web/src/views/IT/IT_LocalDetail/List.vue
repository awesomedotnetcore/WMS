          ...
          <a-col :md="4" :sm="24">
            <a-form-item label="查询类别">
              <a-select allowClear v-model="queryParam.condition">
                ...
                <a-select-option key="TrayId">托盘号ID</a-select-option>
                <a-select-option key="ZonedId">托盘分区ID</a-select-option>
                ...
                <a-select-option key="InputTime">入库时间</a-select-option>
              </a-select>
            </a-form-item>
          </a-col>
          <a-col :md="4" :sm="24">
...
const columns = [
  ...
  { title: '托盘号ID', dataIndex: 'TrayId', width: '10%' },
  { title: '托盘分区ID', dataIndex: 'ZonedId', width: '10%' },
  ...
  { title: '入库时间', dataIndex: 'InputTime', width: '10%' },
      ...
      this.$confirm({
        ...
        onOk() {
          return new Promise((resolve, reject) => {
            thisObj.$http.post('/IT/IT_LocalDetail/DeleteData', ids).then(resJson => {
              resolve()
