        ...
        <a-row>
          <a-col :span="12">
            <a-form-model-item label="计划编号" prop="Code">
              <a-input v-model="entity.Code" autocomplete="off" :disabled="$para('PlanCode')=='1'" placeholder="系统自动生成" >
        ...
        <a-row>
          <a-col :span="12">
            <a-form-model-item label="数量" prop="Num">
              <a-input-number v-model="entity.Num" placeholder="数量" :style="{width:'100%'}" autocomplete="off" />
            </a-form-model-item>
          </a-col>
          <a-col :span="12">
        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-model-item label="完成日期" prop="FinishDate">
              <a-date-picker v-model="entity.FinishDate" :style="{width:'100%'}" autocomplete="off" />
            </a-form-model-item>
          </a-col>
        </a-row>
        <a-row>
